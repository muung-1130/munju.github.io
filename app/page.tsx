...
import { Card, MiniLineChart, StatCard } from '@/components/UI';
import { FeatureBanner } from '@/components/FeatureBanner';
import { AiRecoPanel } from '@/components/AiRecoPanel';
import { HomeGreeting } from '@/components/HomeGreeting';
import { WeatherPanel } from '@/components/WeatherPanel';
import { authOptions } from '@/lib/auth';
import { getRunningSummary, formatDuration, formatPace } from '@/lib/runningRecord';
...
export default async function HomePage() {
  ...
  const [summary, recoCourses] = await Promise.all([
